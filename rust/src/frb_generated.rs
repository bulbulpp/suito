...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 333747364;
...
fn wire__crate__api__exchange__fetch_exchange_rates_from_network_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "fetch_exchange_rates_from_network",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok =
                            crate::api::exchange::fetch_exchange_rates_from_network().await?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn wire__crate__api__greet__greet_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(crate::api::greet::greet(api_name))?;
                    Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__greet__init_app_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
...
fn wire__crate__api__nostr__nostr_nip44_decrypt_v2_from_self_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "nostr_nip44_decrypt_v2_from_self",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::nostr::nostr_nip44_decrypt_v2_from_self(
                            api_ciphertext,
                            api_secret_key,
                        )?;
                        Ok(output_ok)
...
fn wire__crate__api__nostr__nostr_nip44_encrypt_v2_for_self_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "nostr_nip44_encrypt_v2_for_self",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::nostr::nostr_nip44_encrypt_v2_for_self(
                            api_plaintext,
                            api_secret_key,
                        )?;
                        Ok(output_ok)
...
fn wire__crate__api__nostr__nostr_sign_encrypted_replaceable_event_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "nostr_sign_encrypted_replaceable_event",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_secret_key = <String>::sse_decode(&mut deserializer);
            let api_d_tag_identifier = <String>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| async move {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || async move {
                        let output_ok = crate::api::nostr::nostr_sign_encrypted_replaceable_event(
                            api_json_payload,
                            api_secret_key,
                            api_d_tag_identifier,
                        )
                        .await?;
                        Ok(output_ok)
                    })()
...
fn wire__crate__api__nostr__nostr_verify_event_json_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "nostr_verify_event_json",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::nostr::nostr_verify_event_json(api_event_json)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
impl SseDecode for crate::api::exchange::FetchedExchangeRate {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_pairKey = <String>::sse_decode(deserializer);
        let mut var_rate = <i64>::sse_decode(deserializer);
        let mut var_fetchedAtMillisSinceEpochUtc = <i64>::sse_decode(deserializer);
        let mut var_source = <Option<String>>::sse_decode(deserializer);
        return crate::api::exchange::FetchedExchangeRate {
            pair_key: var_pairKey,
            rate: var_rate,
            fetched_at_millis_since_epoch_utc: var_fetchedAtMillisSinceEpochUtc,
            source: var_source,
        };
    }
}
...
impl SseDecode for Vec<crate::api::exchange::FetchedExchangeRate> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = Vec::with_capacity(len_ as usize);
        for idx_ in 0..len_ {
            ans_.push(<crate::api::exchange::FetchedExchangeRate>::sse_decode(
                deserializer,
            ));
        }
        return ans_;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__nostr__nostr_nip44_decrypt_v2_from_self_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        6 => wire__crate__api__nostr__nostr_nip44_encrypt_v2_for_self_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__nostr__nostr_sign_encrypted_replaceable_event_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        8 => {
            wire__crate__api__nostr__nostr_verify_event_json_impl(port, ptr, rust_vec_len, data_len)
        }
        _ => unreachable!(),
    }
}
...
impl flutter_rust_bridge::IntoDart for crate::api::exchange::FetchedExchangeRate {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.pair_key.into_into_dart().into_dart(),
            self.rate.into_into_dart().into_dart(),
            self.fetched_at_millis_since_epoch_utc
                .into_into_dart()
                .into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::exchange::FetchedExchangeRate
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::exchange::FetchedExchangeRate>
    for crate::api::exchange::FetchedExchangeRate
{
    fn into_into_dart(self) -> crate::api::exchange::FetchedExchangeRate {
        self
    }
}
...
impl SseEncode for crate::api::exchange::FetchedExchangeRate {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.pair_key, serializer);
        <i64>::sse_encode(self.rate, serializer);
        <i64>::sse_encode(self.fetched_at_millis_since_epoch_utc, serializer);
...
impl SseEncode for Vec<crate::api::exchange::FetchedExchangeRate> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::exchange::FetchedExchangeRate>::sse_encode(item, serializer);
        }
    }
}
